...
$ds_name[3] = 'Cache';
$def[3] .= "LINE1:query-cache-hit" . "#009900" . "FF:\"$NAME[3]\t\" " ;
...
$def[3] .= "LINE1:query-cache-miss" . "#99FF99" . "FF:\"$NAME[8]\t\" " ;
...
$def[3] .= "LINE1:packetcache-hit" . "#000099" . "FF:\"$NAME[5]\t\" " ;
...
$ds_name[4] = 'Recursor';
$def[4] .= "LINE1:recursing-questions" . "#990000" . "FF:\"".substr_replace($NAME[6], '', 17)."\t\" " ;
...
$def[4] .= "LINE1:recursing-answers" . "#FF9999" . "FF:\"$NAME[4]\t\" " ;
